...
//
//                    return new IdentityKeyRecord(keyId, timestamp, new ECKeyPair(publicKey, privateKey), signature);
...
//                    long         timestamp  = cursor.getLong(cursor.getColumnIndexOrThrow(TIMESTAMP));
//
//                    results.add(new IdentityKeyRecord(keyId, timestamp, new ECKeyPair(publicKey, privateKey), signature));
//                } catch (InvalidKeyException | IOException e) {
//                    e.printStackTrace();
//                }
//            }

...
Stick is the protocol used in <a href="https://www.sticknet.org">Sticknet</a> - an end-to-end encrypted and
decentralized cloud storage, with an intergrated social network.

<b>Note</b>: <i>Although the Stick Protocol was initially developed with a primary focus on social network platforms, it
can be extended to other areas where end-to-end encrypted re-establishable sessions would be useful, such as cloud
storages.</i>
...
can be run as follows: `verifpal verify test_file.vp`. Tests 01->04 are expected to pass, while test 05 is expected to fail.
